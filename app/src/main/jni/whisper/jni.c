...
Java_com_elishaazaria_sayboard_ime_recognizers_WhisperLib_initContextFromInputStream(
...
JNIEXPORT jlong JNICALL
Java_com_elishaazaria_sayboard_ime_recognizers_WhisperLib_initContextFromAsset(
